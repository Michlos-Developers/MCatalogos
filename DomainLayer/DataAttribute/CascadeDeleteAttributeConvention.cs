...
namespace DomainLayer.DataAttribute
{
    public class CascadeDeleteAttributeConvention : IConceptualModelConvention<AssociationType>
    {
        ...
        static CascadeDeleteAttributeConvention()
        {
            ...
            var IsRerefencingMethod = associationTypeExtensionsType.GetMethod("IsSelfReferencing", BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static);
            IsSelfReferencing = associationType => (bool)IsRerefencingMethod.Invoke(null, new object[] { associationType });
